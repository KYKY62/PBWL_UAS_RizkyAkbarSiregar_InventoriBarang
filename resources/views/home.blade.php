            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <h5 class="card-title text-center">Selamat Datang di Halaman Depan
                            {{ config('app.name', 'Laravel') }}</h5>
                        <p class="card-text text-center">Website Ini Dipergunakan Sebagai Pencatatan Inventori Barang Pada
                            Grosir Johor</p>
